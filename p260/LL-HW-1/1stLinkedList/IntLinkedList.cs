...
namespace _1stLinkedList
{
    public class IntLinkedList
    {
        ...
        internal void InsertAtEnd(int v)
        {
            ...
            if (cur == null)
            {
                InsertAtFront(newNode.node_data);
            }
            else {
                while (cur.node_next_pointer != null)
                {
        ...
        internal int RemoveFromEnd()
        {
            ...
            else if (cur.node_next_pointer == null)
            {
                returnVal = cur.node_data;
                frontOfList = null;
            }
            else
            {
                ...
                { 
                    lastNode = cur;
                    cur = lastNode.node_next_pointer;
                }
                lastNode.node_next_pointer = null;
                returnVal = cur.node_data;
