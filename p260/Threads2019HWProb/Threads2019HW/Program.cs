...
namespace Threads2019HW
{
    class Program
    {
        ...
        public static void DotNetSort(object localArray)
        {
            //===========================================================
            ...
            //Console.WriteLine(string.Join("  ", (int[])localArray));

        }


        public static void BubbleSort(object localArray)
        {
            int[] tempArray = (int[])localArray;
            int swapVar;
            //===========================================================
