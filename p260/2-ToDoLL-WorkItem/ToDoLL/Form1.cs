...
namespace ToDoLL
{
    public partial class Form1 : Form
    {
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            //ewWorkItem.Value = Convert.ToInt32(textBoxValue.Text);  // set its values
            newWorkItem.What = textBoxWhat.Text;
            newWorkItem.Why = textBoxWhy.Text;
            ToDoLL.InsertAtFront(Convert.ToInt32(textBoxValue.Text), newWorkItem);  // insert it at front of LL  (first in, last out)
