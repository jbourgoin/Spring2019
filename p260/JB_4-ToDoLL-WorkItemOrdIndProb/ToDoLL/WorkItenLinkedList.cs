...
namespace ToDoLL
{
    class WorkItenLinkedList
    {
        ...
        protected class LinkedListNode
        {
            ...
            public Book theBook; // holds an object with real data
            ...
            public LinkedListNode(Book aBook)
            {
                theBook = aBook; // set the value of the data object to the one passed in
                theBook.Rating = aBook.Rating;
                theBook.Title = aBook.Title;
                theBook.Author = aBook.Author;
        ...
        public void InsertAtFront(Book aBook)
        {
            LinkedListNode newNode = new LinkedListNode(aBook);  // create a new node
        ...
        public Book RemoveFromFront()  // just had to change method from int to return a WorkItem instead
        {
            ...
            else
            {
                ...
                returnBook = frontOfList.theBook; // get the object from the node at the front of the list
        ...
        public void InsertInOrder(Book aBook)
        {
            ...
            // this has to changd
            if (frontOfList == null || frontOfList.theBook.Rating >= aBook.Rating)  // watch the pointers to see what happens
            {
                InsertAtFront(aBook);
            }
            else  // we have to traverse the LL and find where to add a new node
            {
                ...
                // this line changed
                while (current.node_next_pointer != null && current.node_next_pointer.theBook.Rating < aBook.Rating)
                {
        ...
        // write new method here:  Please use 1 as the highest priority (not 0), test your program by entering work items with priorities in this order:
        // 3  1  5  2  4
        // You program should then retrieve them as 1  2  3  4  5

        // Method to add a node in order, based on a supplied Index
        //public void  InsertAt(Book aBook)
        //{
        //    // your code here
